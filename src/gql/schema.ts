...
export type ResolversUnionTypes<RefType extends Record<string, unknown>> = {
  ...
  CartCompletionAttemptResult: ( Omit<CartCompletionActionRequired, 'action'> & { action?: Maybe<RefType['CartCompletionAction']> } ) | ( CartCompletionFailed ) | ( CartCompletionProcessing ) | ( CartCompletionSuccess );
  ...
  MetafieldParentResource: ( Article ) | ( Blog ) | ( Cart ) | ( Collection ) | ( Customer ) | ( Location ) | ( Market ) | ( Order ) | ( Page ) | ( Product ) | ( ProductVariant ) | ( Shop );
  MetafieldReference: ( Collection ) | ( GenericFile ) | ( MediaImage ) | ( Metaobject ) | ( Page ) | ( Product ) | ( ProductVariant ) | ( Video );
...
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = {
  BaseCartLine: ( Omit<CartLine, 'merchandise'> & { merchandise: RefType['Merchandise'] } ) | ( Omit<ComponentizableCartLine, 'merchandise'> & { merchandise: RefType['Merchandise'] } );
  CartDiscountAllocation: ( CartAutomaticDiscountAllocation ) | ( CartCodeDiscountAllocation ) | ( CartCustomDiscountAllocation );
  DiscountApplication: ( Omit<AutomaticDiscountApplication, 'value'> & { value: RefType['PricingValue'] } ) | ( Omit<DiscountCodeApplication, 'value'> & { value: RefType['PricingValue'] } ) | ( Omit<ManualDiscountApplication, 'value'> & { value: RefType['PricingValue'] } ) | ( Omit<ScriptDiscountApplication, 'value'> & { value: RefType['PricingValue'] } );
  DisplayableError: ( CartUserError ) | ( CheckoutUserError ) | ( CustomerUserError ) | ( MetafieldDeleteUserError ) | ( MetafieldsSetUserError ) | ( UserError );
  HasMetafields: ( Article ) | ( Blog ) | ( Cart ) | ( Collection ) | ( Customer ) | ( Location ) | ( Market ) | ( Order ) | ( Page ) | ( Product ) | ( ProductVariant ) | ( Shop );
  Media: ( ExternalVideo ) | ( MediaImage ) | ( Model3d ) | ( Video );
  Node: ( AppliedGiftCard ) | ( Article ) | ( Blog ) | ( Cart ) | ( Omit<CartLine, 'merchandise'> & { merchandise: RefType['Merchandise'] } ) | ( Checkout ) | ( CheckoutLineItem ) | ( Collection ) | ( Comment ) | ( Omit<ComponentizableCartLine, 'merchandise'> & { merchandise: RefType['Merchandise'] } ) | ( ExternalVideo ) | ( GenericFile ) | ( Location ) | ( MailingAddress ) | ( Market ) | ( MediaImage ) | ( MediaPresentation ) | ( Menu ) | ( Omit<MenuItem, 'resource'> & { resource?: Maybe<RefType['MenuItemResource']> } ) | ( Omit<Metafield, 'parentResource' | 'reference'> & { parentResource: RefType['MetafieldParentResource'], reference?: Maybe<RefType['MetafieldReference']> } ) | ( Metaobject ) | ( Model3d ) | ( Order ) | ( Page ) | ( Payment ) | ( Product ) | ( ProductOption ) | ( ProductVariant ) | ( Shop ) | ( ShopPolicy ) | ( UrlRedirect ) | ( Video );
...
export type ResolversTypes = {
  ...
  CartBuyerIdentity: ResolverTypeWrapper<Omit<CartBuyerIdentity, 'deliveryAddressPreferences'> & { deliveryAddressPreferences: Array<ResolversTypes['DeliveryAddress']> }>;
  ...
  ComponentizableCartLine: ResolverTypeWrapper<Omit<ComponentizableCartLine, 'merchandise'> & { merchandise: ResolversTypes['Merchandise'] }>;
  ...
  MenuItem: ResolverTypeWrapper<Omit<MenuItem, 'resource'> & { resource?: Maybe<ResolversTypes['MenuItemResource']> }>;
  ...
  Metafield: ResolverTypeWrapper<Omit<Metafield, 'parentResource' | 'reference'> & { parentResource: ResolversTypes['MetafieldParentResource'], reference?: Maybe<ResolversTypes['MetafieldReference']> }>;
  ...
  MetafieldReferenceConnection: ResolverTypeWrapper<Omit<MetafieldReferenceConnection, 'nodes'> & { nodes: Array<ResolversTypes['MetafieldReference']> }>;
  ...
  MetaobjectField: ResolverTypeWrapper<Omit<MetaobjectField, 'reference'> & { reference?: Maybe<ResolversTypes['MetafieldReference']> }>;
  ...
  SearchResultItemConnection: ResolverTypeWrapper<Omit<SearchResultItemConnection, 'nodes'> & { nodes: Array<ResolversTypes['SearchResultItem']> }>;
...
export type ResolversParentTypes = {
  ...
  CartBuyerIdentity: Omit<CartBuyerIdentity, 'deliveryAddressPreferences'> & { deliveryAddressPreferences: Array<ResolversParentTypes['DeliveryAddress']> };
  CartBuyerIdentityInput: CartBuyerIdentityInput;
  ...
  ComponentizableCartLine: Omit<ComponentizableCartLine, 'merchandise'> & { merchandise: ResolversParentTypes['Merchandise'] };
  Country: Country;
  ...
  Menu: Menu;
  MenuItem: Omit<MenuItem, 'resource'> & { resource?: Maybe<ResolversParentTypes['MenuItemResource']> };
  ...
  Metafield: Omit<Metafield, 'parentResource' | 'reference'> & { parentResource: ResolversParentTypes['MetafieldParentResource'], reference?: Maybe<ResolversParentTypes['MetafieldReference']> };
  ...
  MetafieldReferenceConnection: Omit<MetafieldReferenceConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['MetafieldReference']> };
  ...
  MetaobjectField: Omit<MetaobjectField, 'reference'> & { reference?: Maybe<ResolversParentTypes['MetafieldReference']> };
  MetaobjectHandleInput: MetaobjectHandleInput;
  Model3d: Model3d;
  ...
  SearchResultItemConnection: Omit<SearchResultItemConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['SearchResultItem']> };
...
export type ArticleResolvers<ContextType = any, ParentType extends ResolversParentTypes['Article'] = ResolversParentTypes['Article']> = {
  ...
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<ArticleMetafieldArgs, 'key' | 'namespace'>>;
...
export type BlogResolvers<ContextType = any, ParentType extends ResolversParentTypes['Blog'] = ResolversParentTypes['Blog']> = {
  ...
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<BlogMetafieldArgs, 'key' | 'namespace'>>;
...
export type CartResolvers<ContextType = any, ParentType extends ResolversParentTypes['Cart'] = ResolversParentTypes['Cart']> = {
  ...
  deliveryGroups?: Resolver<ResolversTypes['CartDeliveryGroupConnection'], ParentType, ContextType, RequireFields<CartDeliveryGroupsArgs, 'reverse'>>;
  discountAllocations?: Resolver<Array<ResolversTypes['CartDiscountAllocation']>, ParentType, ContextType>;
  ...
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CartMetafieldArgs, 'key' | 'namespace'>>;
...
export type CartBuyerIdentityResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartBuyerIdentity'] = ResolversParentTypes['CartBuyerIdentity']> = {
  ...
  walletPreferences?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DisplayableErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['DisplayableError'] = ResolversParentTypes['DisplayableError']> = {
  __resolveType: TypeResolveFn<'CartUserError' | 'CheckoutUserError' | 'CustomerUserError' | 'MetafieldDeleteUserError' | 'MetafieldsSetUserError' | 'UserError', ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type HasMetafieldsResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasMetafields'] = ResolversParentTypes['HasMetafields']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Cart' | 'Collection' | 'Customer' | 'Location' | 'Market' | 'Order' | 'Page' | 'Product' | 'ProductVariant' | 'Shop', ParentType, ContextType>;
...
export type LocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Location'] = ResolversParentTypes['Location']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<LocationMetafieldArgs, 'key' | 'namespace'>>;
...
export type MarketResolvers<ContextType = any, ParentType extends ResolversParentTypes['Market'] = ResolversParentTypes['Market']> = {
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<MarketMetafieldArgs, 'key' | 'namespace'>>;
...
export type MenuItemResourceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MenuItemResource'] = ResolversParentTypes['MenuItemResource']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Collection' | 'Page' | 'Product' | 'ShopPolicy', ParentType, ContextType>;
};
...
export type MetafieldReferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldReference'] = ResolversParentTypes['MetafieldReference']> = {
  __resolveType: TypeResolveFn<'Collection' | 'GenericFile' | 'MediaImage' | 'Metaobject' | 'Page' | 'Product' | 'ProductVariant' | 'Video', ParentType, ContextType>;
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  cartNoteUpdate?: Resolver<Maybe<ResolversTypes['CartNoteUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartNoteUpdateArgs, 'cartId'>>;
  ...
  checkoutDiscountCodeApplyV2?: Resolver<Maybe<ResolversTypes['CheckoutDiscountCodeApplyV2Payload']>, ParentType, ContextType, RequireFields<MutationCheckoutDiscountCodeApplyV2Args, 'checkoutId' | 'discountCode'>>;
  ...
  checkoutGiftCardsAppend?: Resolver<Maybe<ResolversTypes['CheckoutGiftCardsAppendPayload']>, ParentType, ContextType, RequireFields<MutationCheckoutGiftCardsAppendArgs, 'checkoutId' | 'giftCardCodes'>>;
  checkoutLineItemsAdd?: Resolver<Maybe<ResolversTypes['CheckoutLineItemsAddPayload']>, ParentType, ContextType, RequireFields<MutationCheckoutLineItemsAddArgs, 'checkoutId' | 'lineItems'>>;
  ...
  checkoutLineItemsReplace?: Resolver<Maybe<ResolversTypes['CheckoutLineItemsReplacePayload']>, ParentType, ContextType, RequireFields<MutationCheckoutLineItemsReplaceArgs, 'checkoutId' | 'lineItems'>>;
  ...
  checkoutShippingAddressUpdateV2?: Resolver<Maybe<ResolversTypes['CheckoutShippingAddressUpdateV2Payload']>, ParentType, ContextType, RequireFields<MutationCheckoutShippingAddressUpdateV2Args, 'checkoutId' | 'shippingAddress'>>;
...
export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'AppliedGiftCard' | 'Article' | 'Blog' | 'Cart' | 'CartLine' | 'Checkout' | 'CheckoutLineItem' | 'Collection' | 'Comment' | 'ComponentizableCartLine' | 'ExternalVideo' | 'GenericFile' | 'Location' | 'MailingAddress' | 'Market' | 'MediaImage' | 'MediaPresentation' | 'Menu' | 'MenuItem' | 'Metafield' | 'Metaobject' | 'Model3d' | 'Order' | 'Page' | 'Payment' | 'Product' | 'ProductOption' | 'ProductVariant' | 'Shop' | 'ShopPolicy' | 'UrlRedirect' | 'Video', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};
...
export type OnlineStorePublishableResolvers<ContextType = any, ParentType extends ResolversParentTypes['OnlineStorePublishable'] = ResolversParentTypes['OnlineStorePublishable']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Collection' | 'Page' | 'Product', ParentType, ContextType>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
};
...
export type PageResolvers<ContextType = any, ParentType extends ResolversParentTypes['Page'] = ResolversParentTypes['Page']> = {
  ...
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<PageMetafieldArgs, 'key' | 'namespace'>>;
...
export type QueryRootResolvers<ContextType = any, ParentType extends ResolversParentTypes['QueryRoot'] = ResolversParentTypes['QueryRoot']> = {
  ...
  productRecommendations?: Resolver<Maybe<Array<ResolversTypes['Product']>>, ParentType, ContextType, RequireFields<QueryRootProductRecommendationsArgs, 'intent' | 'productId'>>;
...
export const AddCartLinesDocument = gql`
  ...
  cartLinesAdd(cartId: $cartId, lines: $lines) {
    ...
    `;
export type AddCartLinesMutationFn = Apollo.MutationFunction<AddCartLinesMutation, AddCartLinesMutationVariables>;
 ...
 * });
 */
export function useAddCartLinesMutation(baseOptions?: Apollo.MutationHookOptions<AddCartLinesMutation, AddCartLinesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddCartLinesMutation, AddCartLinesMutationVariables>(AddCartLinesDocument, options);
      }
export type AddCartLinesMutationHookResult = ReturnType<typeof useAddCartLinesMutation>;
export type AddCartLinesMutationResult = Apollo.MutationResult<AddCartLinesMutation>;
export type AddCartLinesMutationOptions = Apollo.BaseMutationOptions<AddCartLinesMutation, AddCartLinesMutationVariables>;
 ...
 * });
 */
export function useGetShopIdQuery(baseOptions?: Apollo.QueryHookOptions<GetShopIdQuery, GetShopIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetShopIdQuery, GetShopIdQueryVariables>(GetShopIdDocument, options);
      }
export function useGetShopIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetShopIdQuery, GetShopIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetShopIdQuery, GetShopIdQueryVariables>(GetShopIdDocument, options);
        }
export type GetShopIdQueryHookResult = ReturnType<typeof useGetShopIdQuery>;
export type GetShopIdLazyQueryHookResult = ReturnType<typeof useGetShopIdLazyQuery>;
export type GetShopIdQueryResult = Apollo.QueryResult<GetShopIdQuery, GetShopIdQueryVariables>;
export const UpdateCartLinesDocument = gql`
  ...
  cartLinesUpdate(cartId: $cartId, lines: $lines) {
    ...
    `;
export type UpdateCartLinesMutationFn = Apollo.MutationFunction<UpdateCartLinesMutation, UpdateCartLinesMutationVariables>;
 ...
 * });
 */
export function useUpdateCartLinesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCartLinesMutation, UpdateCartLinesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCartLinesMutation, UpdateCartLinesMutationVariables>(UpdateCartLinesDocument, options);
      }
export type UpdateCartLinesMutationHookResult = ReturnType<typeof useUpdateCartLinesMutation>;
export type UpdateCartLinesMutationResult = Apollo.MutationResult<UpdateCartLinesMutation>;
export type UpdateCartLinesMutationOptions = Apollo.BaseMutationOptions<UpdateCartLinesMutation, UpdateCartLinesMutationVariables>;
...
export type AddCartLinesMutation = { __typename?: 'Mutation', cartLinesAdd?: { __typename?: 'CartLinesAddPayload', cart?: { __typename?: 'Cart', id: string, totalQuantity: number, lines: { __typename?: 'BaseCartLineConnection', edges: Array<{ __typename?: 'BaseCartLineEdge', node: { __typename?: 'CartLine', id: string, quantity: number, merchandise: { __typename?: 'ProductVariant', id: string } } | { __typename?: 'ComponentizableCartLine', id: string, quantity: number, merchandise: { __typename?: 'ProductVariant', id: string } } }> }, cost: { __typename?: 'CartCost', totalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, subtotalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, totalTaxAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null, totalDutyAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null } } | null, userErrors: Array<{ __typename?: 'CartUserError', field?: Array<string> | null, message: string }> } | null };

export type CreateCartMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateCartMutation = { __typename?: 'Mutation', cartCreate?: { __typename?: 'CartCreatePayload', cart?: { __typename?: 'Cart', id: string, createdAt: any, updatedAt: any, totalQuantity: number } | null } | null };
...
export type GetCartQuery = { __typename?: 'QueryRoot', cart?: { __typename?: 'Cart', id: string, createdAt: any, updatedAt: any, totalQuantity: number, lines: { __typename?: 'BaseCartLineConnection', edges: Array<{ __typename?: 'BaseCartLineEdge', node: { __typename?: 'CartLine', id: string, quantity: number, cost: { __typename?: 'CartLineCost', totalAmount: { __typename?: 'MoneyV2', amount: any } }, merchandise: { __typename?: 'ProductVariant', id: string, title: string, product: { __typename?: 'Product', title: string } }, attributes: Array<{ __typename?: 'Attribute', key: string, value?: string | null }> } | { __typename?: 'ComponentizableCartLine', id: string, quantity: number, cost: { __typename?: 'CartLineCost', totalAmount: { __typename?: 'MoneyV2', amount: any } }, merchandise: { __typename?: 'ProductVariant', id: string, title: string, product: { __typename?: 'Product', title: string } }, attributes: Array<{ __typename?: 'Attribute', key: string, value?: string | null }> } }> }, attributes: Array<{ __typename?: 'Attribute', key: string, value?: string | null }>, cost: { __typename?: 'CartCost', totalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, subtotalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, totalTaxAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null, totalDutyAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null }, buyerIdentity: { __typename?: 'CartBuyerIdentity', email?: string | null, phone?: string | null, countryCode?: CountryCode | null, customer?: { __typename?: 'Customer', id: string } | null, deliveryAddressPreferences: Array<{ __typename?: 'MailingAddress', address1?: string | null, address2?: string | null, city?: string | null, provinceCode?: string | null, countryCodeV2?: CountryCode | null, zip?: string | null }> } } | null };
...
export type GetCustomerQuery = { __typename?: 'QueryRoot', customer?: { __typename?: 'Customer', id: string, email?: string | null, phone?: string | null, createdAt: any, updatedAt: any } | null };
...
export type GetProductsQuery = { __typename?: 'QueryRoot', products: { __typename?: 'ProductConnection', edges: Array<{ __typename?: 'ProductEdge', node: { __typename?: 'Product', id: string, title: string, variants: { __typename?: 'ProductVariantConnection', edges: Array<{ __typename?: 'ProductVariantEdge', node: { __typename?: 'ProductVariant', id: string, title: string, price: { __typename?: 'MoneyV2', amount: any } } }> } } }> } };

export type GetShopIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetShopIdQuery = { __typename?: 'QueryRoot', shop: { __typename?: 'Shop', id: string } };
...
export type UpdateCartLinesMutation = { __typename?: 'Mutation', cartLinesUpdate?: { __typename?: 'CartLinesUpdatePayload', cart?: { __typename?: 'Cart', id: string, totalQuantity: number, lines: { __typename?: 'BaseCartLineConnection', edges: Array<{ __typename?: 'BaseCartLineEdge', node: { __typename?: 'CartLine', id: string, quantity: number, merchandise: { __typename?: 'ProductVariant', id: string } } | { __typename?: 'ComponentizableCartLine', id: string, quantity: number, merchandise: { __typename?: 'ProductVariant', id: string } } }> }, cost: { __typename?: 'CartCost', totalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, subtotalAmount: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode }, totalTaxAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null, totalDutyAmount?: { __typename?: 'MoneyV2', amount: any, currencyCode: CurrencyCode } | null } } | null, userErrors: Array<{ __typename?: 'CartUserError', field?: Array<string> | null, message: string }> } | null };
