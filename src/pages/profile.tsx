          ...
          <div className="my-1 flex h-full flex-col">
            ...
            <div className="mx-10 mt-10">
              ...
              <div className="mb-20 flex items-center gap-10">
                ...
                <div className="select-none text-[#B98068]">
              ...
              <div className="flex flex-col gap-10">
                <div className="flex h-[80px] cursor-pointer select-none items-center justify-center rounded-2xl border-2 border-[#B98068] bg-[#F8E6CF] bg-background-light bg-cover text-[20px] font-semibold text-[#B98068] shadow-md hover:drop-shadow-strDrop">
                  My Orders
                </div>
                <div className="flex h-[80px] cursor-pointer select-none items-center justify-center rounded-2xl border-2 border-[#B98068] bg-[#F8E6CF] bg-background-light bg-cover text-[20px] font-semibold text-[#B98068] shadow-md hover:drop-shadow-strDrop">
                  My Orders
            ...
            <div className="mx-10 mb-4 mt-auto flex h-[47px] cursor-pointer select-none items-center justify-center gap-2 rounded-2xl border-2 border-[#B98068] text-[20px] font-bold text-[#B98068] shadow-sm hover:shadow-md">
              <svg
                width="25"
                height="27"
                viewBox="0 0 25 27"
